...
test_bot is a chat bot built on the [Hubot][hubot] framework. It was initially generated by [generator-hubot][generator-hubot], and configured to be deployed on [Heroku][heroku] to get you up and running as quick as possible.
...
### Running test_bot Locally

You can test your hubot by running the following.

You can start test_bot locally by running:
...
Then you can interact with test_bot by typing `test_bot help`.

    test_bot> test_bot help

    test_bot> animate me <query> - The same thing as `image me`, except adds a few
